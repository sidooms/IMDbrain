...
function goto_recommendations_page(){
    ...
    chrome.tabs.getAllInWindow(null, function(tabs) {
        ...
        tabs.forEach(function(tab){
            if (tab.title == 'IMDbrain -- Recommendations'){
...
function goto_feedback_page(){
    ...
    chrome.tabs.getAllInWindow(null, function(tabs) {
        var foundit = false;
        tabs.forEach(function(tab){
            if (tab.title == 'IMDbrain -- Feedback'){
                //if yes: goto existing
                chrome.tabs.update(tab.id, {selected: true});
                foundit = true;
            }
...
function close_tabs(){
    chrome.tabs.getAllInWindow(null, function(tabs) {
        ...
        tabs.forEach(function(tab){
            if (tab.title == 'IMDbrain -- Recommendations' || tab.title=='IMDbrain -- Settings and Filters' || tab.title=='IMDbrain -- Feedback'){
